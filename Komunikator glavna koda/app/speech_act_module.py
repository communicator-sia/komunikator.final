...
def print_out(question, response):
    ...
    fileName=r'C:\Users\jeans\Downloads\KomunikatorFakeDemo\Komunikator glavna koda\app\intents2.json'
...
def get_response(text):
    ...
    os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = r'C:\Users\jeans\Downloads\KomunikatorFakeDemo\Komunikator glavna koda\app\vaja-stqi-a94d4033cbd5.json'
